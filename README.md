...
|---------|-------------|------------|
| **LLM Evaluator Platform** | Built a system to evaluate and benchmark Large Language Models on accuracy, reasoning, and response quality using structured metrics and dashboards | Python, NLP, LLMs, FastAPI, typescript |
